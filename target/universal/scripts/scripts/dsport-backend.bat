@REM dsport-backend launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM DSPORT_BACKEND_config.txt found in the DSPORT_BACKEND_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%DSPORT_BACKEND_HOME%"=="" set "DSPORT_BACKEND_HOME=%~dp0\\.."

set "APP_LIB_DIR=%DSPORT_BACKEND_HOME%\lib\"
...
set "CFG_FILE=%DSPORT_BACKEND_HOME%\DSPORT_BACKEND_config.txt"
set CFG_OPTS=
if exist "%CFG_FILE%" (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running dsport-backend.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !DSPORT_BACKEND_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
